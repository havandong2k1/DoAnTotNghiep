            ...
            <div class="position-center">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="coupon_date_start" class="form-control" id="datepicker_coupon_start" >
                </div>
                 <div class="form-group">
                    <label for="exampleInputEmail1">Ngày kết thúc</label>
                    <input type="text" name="coupon_date_end" class="form-control" id="datepicker_coupon_end" >
                </div>
                <div class="form-group">
