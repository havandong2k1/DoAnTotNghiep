                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                 <li><a href="tel:0923199330"><i class="fa fa-phone"></i> 0943997901</a></li>
                                <li><a href="mailto:dong.havan@hostingviet.vn"><i class="fa fa-envelope"></i> dong.havan@hostingviet.vn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a id="checkout" href="{{URL::to('/history')}}"><i class="fa fa-archive"></i> Lịch sử mua hàng</a></li>
...
<script type="text/javascript">
    ...
    $('.caculate_delivery').click(function(){
        ...
        var _token = $('input[name="_token"]').val();
        if(matp == '' && maqh =='' && xaid ==''){
            alert('Vui lòng chọn địa điểm để tính phí vận chuyển');
        }else{
            $.ajax({
